...
void ACountDown::CountdownHasFinished()
{
    ...
    AMainPlayer* PlayerChar = Cast<AMainPlayer>(UGameplayStatics::GetPlayerCharacter(GetWorld(), 0));
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("Player character is not an instance of AMainPlayer."));
    }
